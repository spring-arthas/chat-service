package com.hailiang.hai.classalbum;
...
public class ResumableUploadClient {
    ...
    // 服务器配置
    private static final String SERVER_HOST = "172.21.32.54";
    ...
    public static void main(String[] args) {
        ...
        // 示例：上传文件
        String filePath = "/Users/hljy/Downloads/毒药骑行/ppsl/8月26日 (1).mp4"; // 修改为实际文件路径
